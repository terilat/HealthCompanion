...
SYSTEM_PROMPT = (
    ...
    "duration (Ночной сон), score (общая оценка качества сна), deep_stage "
    "(Глубокий сон -- доля глубокого сна в общей продолжительности сна), light_stage (Легкий сон -- доля легкого сна "
    "в общей продолжительности сна), rem_stage (Быстрый сон -- доля быстрого сна в общей продолжительности "
    "сна), time_deep_stage_score (Время глубокого сна -- оценка времени глубокого сна в баллах), wake_up_count (Количество "
    "пробуждений), breathe_quality (Качество дыхания, в баллах), average_pulse (Ср. пульс, уд/мин -- средний пульс "
    "за ночь), average_pulse_variability (Ср. ВСР, мс -- средняя вариабельность пульса), average_spo2 "
    "(Ср. SPO2, % -- средний уровень насыщения крови кислородом), breathe_frequency (Ср. частота дыхания, вдох/мин)."
)
OCR_PROMPT = (
